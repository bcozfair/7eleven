        ...
        <div class="section-body container">
                    ...
                    @foreach ($foods as $food)
                        <div class="col">
                            <div class="card h-100">
                                <img src="{{ $food->image }}" class="product-img" alt="{{ $food->name }}">
                                <div class="card-body">
                                ...
                                <div class="card-footer">
                                    <button class="btn btn-success w-100">ซื้อเลย</button>
                                </div>
                            </div>
                        </div>
                    @endforeach
            ...
            <div class="product-container">
                ...
                <div class="product-card">
                    ...
                    <div class="item-detail"><a
                            href="/new-product/bakery/324-ข้าวหอมมะลิผสมข้าวไรซ์เบอร์รี่ยำอกไก่ย่าง">
                            <h3 class="item-title">
